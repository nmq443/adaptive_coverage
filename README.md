...
## Result arrays
* `swarm_data.npy`: a `num_agents` x `num_timesteps` x 11 (`pos_x`, `pos_y`, `theta`, `goal_x`, `goal_y`, `dx`, `dy`, `speed`, `penalty_flag`, `next_pos_x`, `next_pos_y`) array represents the state of the swarm over time.
