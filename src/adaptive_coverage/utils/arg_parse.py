...
def get_args(default_configs):
    ...
    parser.add_argument("--scale", type=float, help="How much to scale", default=configs["simulation"][
        "scale"])
    parser.add_argument(
        "--linewidth", type=int, help="Linewidth of drawings", default=configs["simulation"]["linewidth"]
    )
    parser.add_argument(
        "--show_sensing_range",
        type=bool,
    ...
    parser.add_argument(
        "--show_goal", type=bool, help="Show agent's goal", default=configs["simulation"]["show_goal"]
    )
    parser.add_argument(
        "--show_connections",
        type=bool,
    ...
    # Results and logs
    parser.add_argument(
        "--res_dir", type=str, help="Where to put results", default=configs["experiments"]["res_dir"]
    )
    parser.add_argument(
        "--log_dir", type=str, help="Where to put log files", default=configs["experiments"]["log_dir"]
    )
