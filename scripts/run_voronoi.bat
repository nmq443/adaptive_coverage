...
start cmd /k python scripts/run.py --env env5 --show_sensing_range True --controller voronoi
start cmd /k python scripts/run.py --env env6 --show_sensing_range True --controller voronoi